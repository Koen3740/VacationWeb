...
exports.importPrijsvrijXml = importPrijsvrijXml;
exports.decodePrijsvrijBoardType = decodePrijsvrijBoardType;
...
function mapPrijsvrijProduct(product) {
    ...
    return {
        externalId: (0, providers_1.buildExternalId)('prijsvrij', product.ID, [
            departureDate,
            duration,
            minimumPrice,
            boardTypeCode,
        ]),
        provider: providers_1.PROVIDERS.prijsvrij.name,
...
function importPrijsvrijXml(xml) {
...
function decodePrijsvrijBoardType(code) {
    return BOARD_TYPE_LABELS[code] ?? code;
}
